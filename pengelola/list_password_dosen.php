    ...
    <table border="0" width="100%" height="100%" align="center">
      ...
      <tr>
        ...
        <td width="50%">
          ...
          <button type="submit" class="btn btn-primary"><a target="_blank" href="print_password_dosen.php" style="color: white">Print</a></button>
          </center>
              </td>
            </tr>
          </table>
