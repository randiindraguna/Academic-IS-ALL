    ...
    <div class="m-3">
        ...
        <div class="row ">
            <div class="box2-1 col-3 bg-two rounded  mt-5 mb-n3">
                <p class="judul mt-3 mb-4 text-center">Edit Data</p>
            </div>
            <div class="col-9"></div>
        </div>
        ...
        <div class="col-12 mt-5">
            <form method="POST" action="../control/edit_semprop.php">
            <div class="row">
            ...
            <div class="row mt-1">
                <div class="col-6 mt-2">                   
                    ...
                    <input class="form-control" id="disabledInput" type="text" placeholder="<?=$nama_penguji?>" disabled>                                
                    <input type="hidden" name="penguji" value="<?=$niy?>">
                </div>
            ...
            <div class="row">
                <div class="col-6 mt-2">
                    <label for="inputState">Waktu</label>
                        <select name="waktu" id="inputState" class="form-control" >
            ...
            <div class="row mb-5 mt-4">
                ...
                <div class="col-4 text-center">
                    <button type="button" class="btn btn-warning" onclick="AlertYakin()">Kembali</button>
