...
<html lang="en">
  <head>
    <style type="text/css">.padding{margin-top: 100px;}</style>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body bgcolor="#808080">
    ...
    <table width="100%" height="100%" align="center">
      <tr><td colspan="3" bgcolor="#808080"><br><br><br><br><br><br>
      <tr>
...
?>
    ...
    <table cellpadding="27" border="0" width="100%" height="20%">
      <tr align="center">
        <td bgcolor="#808080">
          <br><br><br><br><br><br>
          <div id="footer" class="fixed-bottom" style="height:50px; line-height:50px; background:#333; color:white;">
            Copyright &copy; 2019
            Designed by . . . . . . . .
          </div>
        </td>
