...
<?php 
    ...
    $niy_dosen_uji = $_SESSION['dosen_uji'];
    session_destroy();
    $db_penguji = $akses->getDosenPengujibyNIY($niy_dosen_uji);
        ...
        <div class="col-12 ">
            ...
            <div class="col-6 mt-2">               
                    ...
                    <select id="inputState" class="form-control" id="penguji" name="penguji2">
                            ...
                            <?php foreach ($akses->getAllDosenKecualiDuaDosen($niy,$niy_dosen_penguji) as $key ) {?>                            
