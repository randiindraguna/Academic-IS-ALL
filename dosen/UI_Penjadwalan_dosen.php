...
<?php 
    ...
    $niy = $_SESSION['username'];
    include '../Class_penjadwalan.php';
    $P = new Penjadwalan();
    $P->connect();
    $data=$P->getDataJadwalDosenByNiySemua($_SESSION['username']);
...
<body class="bg-tre">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-8 mt-2">
                        <button name="answer" value="<?=$niy?>" class="btn btn-secondary ml-5 mt-5 mb-5" onclick="" id="all">Semua</button>
                        <button name="answer" value="<?=$niy?>" class="btn btn-info mt-5 mb-5 " onclick="" id="terdekat">Jadwal Terdekat</button>
                    </div>
                </div>
                <div class="row">
    ...
    <script src="../js/penjadwalanJSs_dosen.js"></script>
